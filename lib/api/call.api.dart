...
class ApiCall {
  ...
  static post(String url, Map<String, dynamic> data) async {
    ...
    try {
      ...
      final response = await dio.postUri(Uri.parse(url), data: {"data": data});
  ...
  static put(String url, Map<String, dynamic> data) async {
    ...
    try {
      // String encryptedData = EncryptionHelper().encryptAESCryptoJS(jsonEncode(data), AppConst.encryptionKey);
      final response = await dio.putUri(Uri.parse(url), data: {"data": data});
      if (response.data['responseCode'] == 501) {
        ResponseModel responseModel = ResponseModel.fromJson({
          "status": "error",
          "message": response.data['message'],
  ...
  //     final response =
  //         await dio.patchUri(Uri.parse(url), data: {"data": encryptedData});
  //     if (response.data['responseCode'] == 501) {
  //       ResponseModel responseModel = ResponseModel.fromJson({
  //         "status": "error",
  //         "message": response.data['message'],
